process subsample_fastq {
    ...
    # Subsample R1
    ${params.seqtk_path} sample -s\${SEED} ${r1_file} ${subsample_reads} | gzip > subsampled/${sample}_subsampled_R1.fq.gz

    # Subsample R2
    ${params.seqtk_path} sample -s\${SEED} ${r2_file} ${subsample_reads} | gzip > subsampled/${sample}_subsampled_R2.fq.gz
